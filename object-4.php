...
background-image: url('images/Back/background-1.jpg');
...
$(document).ready(function(){
  ...
  Swal.fire({
      icon: 'success',
        html:
      '<h4 style="font-family: "Lato", "Segoe Ui", -apple-system, BlinkMacSystemFont, sans-serif;">Sėkmingai atlikai #4 užduotį.</h4>' +
        '<br>' +
...
<div class="div4">
    <h1 style="font-family: 'Great Vibes', cursive;">Marvos (XII) fortas</h1>
    <br>
...
<div class="slider">
    ...
    <div class="slide"><img src="https://images.unsplash.com/photo-1545436864-cd9bdd1ddebc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" />
      <p style="font-family: 'Great Vibes', cursive;"><b>#2 Marvos (XII) fortas</b></p>
    </div>
    <div class="slide"><img src="images/Objects/question.jpg" />
      <p style="font-family: 'Great Vibes', cursive;"><b>#1 Marvos (XII) fortas</b></p>
    </div>
  </div>
  <br>
  <?php if($Location==3) { ?>
  <div class="quiz4">
    ...
    <br>
    <p>Pasidaryk asmenukę prie Marvos (XII) forto griuvėsiu... (nuotraukos dydis maksimaliai 7.5MB)</p>
    <img id="loader" style="display:none;  margin-left: auto; margin-right: auto;" src="images/loader.gif"/>
    <form class="ikelti" method="POST" action="object-4-submit" enctype="multipart/form-data">
  ...
  <div class="hint4">
   ...
   <iframe src="https://snazzymaps.com/embed/279420" width="100%" height="50%" style="border:none;"></iframe>
  <?php } ?>
