...
<?php
    ...
    if(array_key_exists('vartotojo_duomenys_3_user',$_SESSION) && !empty($_SESSION['vartotojo_duomenys_3_user'])) {
...
$(document).ready(function(){
  ...
  Swal.fire({
      icon: 'success',
        html:
      '<h4 style="font-family: "Lato", "Segoe Ui", -apple-system, BlinkMacSystemFont, sans-serif;">Sėkmingai atlikai #2 užduotį.</h4>' +
        '<br>' +
...
<div class="div2">
    <h1 style="font-family: 'Great Vibes', cursive;">Gimnazijos lauko klasė</h1>
    <br>
...
<div class="slider">
    <!--<div class="slide"><img src="images/Objects/2_objektas.png" />
      <p style="font-family: 'Great Vibes', cursive;" ><b>#4 VDU ŽŪA</b></p>
    </div>
    <div class="slide"><img src="https://images.unsplash.com/photo-1486162928267-e6274cb3106f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" />
      <p style="font-family: 'Great Vibes', cursive;"><b>#3 VDU ŽŪA</b></p>
    </div>-->
    <div class="slide"><img src="https://images.unsplash.com/photo-1545436864-cd9bdd1ddebc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" />
      <p style="font-family: 'Great Vibes', cursive;"><b>#2 Lauko klasė</b></p>
    </div>
    <div class="slide"><img src="images/Objects/question.jpg" />
      <p style="font-family: 'Great Vibes', cursive;"><b>#1 Lauko klasė</b></p>
    </div>
  </div>
  <br>
  <?php if($Location==1) { ?>
  <div class="quiz2">
    ...
    <br>
    <p>Pasidaryk asmenukę prie VDU UKG lauko klasės... (nuotraukos dydis maksimaliai 7.5MB)</p>
    <img id="loader" style="display:none;  margin-left: auto; margin-right: auto;" src="images/loader.gif"/>
    <form class="ikelti" method="POST" action="object-2-submit" enctype="multipart/form-data">
  ...
  <div class="hint2">
   ...
   <iframe src="https://snazzymaps.com/embed/279320" width="100%" height="50%" style="border:none;"></iframe>
  <?php } ?>
