...
<?php
    ...
    $score=$_SESSION['trecio_klausimyno_rezultatas'];
...
$(document).ready(function(){
  ...
  Swal.fire({
      icon: 'success',
        html:
      '<h4 style="font-family: "Lato", "Segoe Ui", -apple-system, BlinkMacSystemFont, sans-serif;">Sėkmingai atlikai #5 užduotį. Tavo rezultatas <?php echo $score; ?>/2</h4>' +
        '<br>' +
...
<div class="div3">
    <h1 style="font-family: 'Great Vibes', cursive;">57 maumedis</h1>
    <br>
...
<div class="slider">
    ...
    <div class="slide"><img src="https://images.unsplash.com/photo-1545436864-cd9bdd1ddebc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" />
      <p style="font-family: 'Great Vibes', cursive;"><b>#2 57 maumedis</b></p>
    </div>
    <div class="slide"><img src="images/Objects/question.jpg" />
      <p style="font-family: 'Great Vibes', cursive;"><b>#1 57 maumedis</b></p>
    </div>
  </div>
  <br>
  <?php if($Location==4) { ?>
  <div class="quiz3">
    ...
    <br>
    <form method="POST" action="object-5-submit">
      <h3 style="font-family: 'Great Vibes', cursive;">Kiek medžių yra aplink 57 maumedį 2 metrų atstumu?</h3>
      <div class="input-container">		
          <input name="5_klausimas" type="number" style="color:black" required/>
      </div>
  ...
  <div class="hint3">
    ...
    <iframe src="https://snazzymaps.com/embed/279435" width="100%" height="50%" style="border:none;"></iframe>
  <?php } ?>
