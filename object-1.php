...
<?php
    ...
    $score=$_SESSION['pirmo_klausimyno_rezultatas'];

    if(array_key_exists('vartotojo_duomenys_2_user',$_SESSION) && !empty($_SESSION['vartotojo_duomenys_2_user'])) {
      $conn = new mysqli($servername, $username, $password, $dbname);

      $sql = "SELECT Current_location, Path_ID FROM Users WHERE ID='$ID'";
...
background-image: url('images/Back/background-4.jpg');
...
$(document).ready(function(){
  ...
  Swal.fire({
      icon: 'success',
        html:
      '<h4 style="font-family: "Lato", "Segoe Ui", -apple-system, BlinkMacSystemFont, sans-serif;">Sėkmingai atlikai #1 užduotį. Tavo rezultatas <?php echo $score; ?>/3</h4>' +
        '<br>' +
...
<div class="div1">
    <h1 style="font-family: 'Great Vibes', cursive;">Vytauto Didžiojo universiteto Ugnės Karvelis gimnazija</h1>
    <br>
...
<div class="slider">
    <!--<div class="slide"><img src="images/Objects/1_objektas.png" />
      <p style="font-family: 'Great Vibes', cursive;" ><b>#4 VDU UKG</b></p>
    </div>
    <div class="slide"><img src="https://images.unsplash.com/photo-1486162928267-e6274cb3106f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" />
      <p style="font-family: 'Great Vibes', cursive;"><b>#3 VDU UKG</b></p>
    </div>-->
    <div class="slide"><img src="https://images.unsplash.com/photo-1545436864-cd9bdd1ddebc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" />
      <p style="font-family: 'Great Vibes', cursive;"><b>#2 VDU UKG</b></p>
    </div>
    <div class="slide"><img src="images/Objects/question.jpg" />
      <p style="font-family: 'Great Vibes', cursive;"><b>#1 VDU UKG</b></p>
    </div>
  </div>
  <br>
  <?php if($Location==0) { ?>
  <div class="quiz1">
    ...
    <br>
    <form method="POST" action="object-1-submit">
      <h3 style="font-family: 'Great Vibes', cursive;">Kada įkurta gimnazija?</h3>
      <div class="input-container">		
          <input name="1_klausimas" type="number" style="color:black" required/>
      </div>

      <h3 style="font-family: 'Great Vibes', cursive;">Ar mokeisi šioje mokykloje?</h3>
      <div class="input-container">		
          <input name="2_klausimas" type="input" style="color:black" autocomplete="off" list="variantai"  required/>
      </div>

      <h3 style="font-family: 'Great Vibes', cursive;">Kada gimanzija tapo VDU dalimi?</h3>
      <div class="input-container">		
          <input name="3_klausimas" type="number" style="color:black" required/>
      </div>
  ...
  <iframe src="https://snazzymaps.com/embed/279315" width="100%" height="50%" style="border:none; margin: 0 auto; text-align: center"></iframe>
  <?php } ?>
