...
<?php
    ...
    if(array_key_exists('vartotojo_duomenys_5_user',$_SESSION) && !empty($_SESSION['vartotojo_duomenys_5_user'])) {
...
background-image: url('images/Back/background-3.jpg');
...
$(document).ready(function(){
  ...
  Swal.fire({
      icon: 'success',
        html:
      '<h4 style="font-family: "Lato", "Segoe Ui", -apple-system, BlinkMacSystemFont, sans-serif;">Sėkmingai atlikai #6 užduotį.</h4>' +
        '<br>' +
  ...
  Swal.fire({
      icon: 'error',
        html:
      '<h4 style="font-family: "Lato", "Segoe Ui", -apple-system, BlinkMacSystemFont, sans-serif;">Nepavyko išsaugoti Tavo nuotraukos</h4>' +
        '<br>' +
        '<p>Pamatei klaidą ar iškilo techninių bėdų, susiekite: <a style="color:dodgerblue; text-decoration:none;" href="mailto:pagalba@bkworks.lt"><strong> pagalba@bkworks.lt</strong></a></p>'
    })
  }
  $('.ikelti').submit(function(e){
    $("#loader").css('display', 'block');
    $(".ikelti").css('display', 'none');
  });
});
...
<div class="div4">
    <h1 style="font-family: 'Great Vibes', cursive;">Kamšos pažintinis takas</h1>
    <br>
...
<div class="slider">
    <!--<div class="slide"><img src="images/Objects/4_objektas.jpg" />
      <p style="font-family: 'Great Vibes', cursive;" ><b>#4 Kamšos paž. takas</b></p>
    </div>
    <div class="slide"><img src="https://images.unsplash.com/photo-1486162928267-e6274cb3106f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" />
      <p style="font-family: 'Great Vibes', cursive;"><b>#3 Kamšos paž. takas</b></p>
    </div>-->
    <div class="slide"><img src="https://images.unsplash.com/photo-1545436864-cd9bdd1ddebc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" />
      <p style="font-family: 'Great Vibes', cursive;"><b>#2 Kamšos pažintinis takas</b></p>
    </div>
    <div class="slide"><img src="images/Objects/question.jpg" />
      <p style="font-family: 'Great Vibes', cursive;"><b>#1 Kamšos pažintinis takas</b></p>
    </div>
  </div>
  <br>
  <?php if($Location==5) { ?>
  <div class="quiz4">
    ...
    <p>Atlik užduotį ir gauk sekančią užuominą</p>
    <br>
    <p>Pasidaryk asmenukę prie ežiuko... (nuotraukos dydis maksimaliai 7.5MB)</p>
    <img id="loader" style="display:none;  margin-left: auto; margin-right: auto;" src="images/loader.gif"/>
    <form class="ikelti" method="POST" action="object-6-submit" enctype="multipart/form-data">
  ...
  <div class="hint4">
   ...
   <iframe src="https://snazzymaps.com/embed/279436" width="100%" height="50%" style="border:none;"></iframe>
  <?php } ?>
