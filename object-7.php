...
<div class="div4">
    <h1 style="font-family: 'Great Vibes', cursive;">Miestelio eglė ir nykštukai</h1>
    <br>
...
<div class="slider">
    ...
    <div class="slide"><img src="https://images.unsplash.com/photo-1545436864-cd9bdd1ddebc?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60" />
      <p style="font-family: 'Great Vibes', cursive;"><b>#2 Miestelio eglė ir nykštukai</b></p>
    </div>
    <div class="slide"><img src="images/Objects/question.jpg" />
      <p style="font-family: 'Great Vibes', cursive;"><b>#1 Miestelio eglė ir nykštukai</b></p>
    </div>
  </div>
  <br>
  <?php if($Location==6) { ?>
  <div class="quiz4">
    ...
    <p>Atlik užduotį ir sėkmingai užbaik Šiaurinį žygį</p>
    <br>
    <p>Pasidaryk asmenukę prie Kalėdinio nykštuko <img width="24px" height="24px" src="images/elf.png"/>... (nuotraukos dydis maksimaliai 7.5MB)</p>
    <img id="loader" style="display:none;  margin-left: auto; margin-right: auto;" src="images/loader.gif"/>
    <form class="ikelti" method="POST" action="object-7-submit" enctype="multipart/form-data">
